...
private:
	...
	int TxRxPacket(unsigned char *txpacket, unsigned char *rxpacket,
			int priority);
...
public:
	...
	int ReadTable(int id, int start_addr, int end_addr, unsigned char *table,
			int *error);
