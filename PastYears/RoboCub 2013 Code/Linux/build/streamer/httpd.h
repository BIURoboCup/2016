...
typedef enum{
    ...
    IN_CMD_MIN_HUE_SET,
    IN_CMD_MIN_HUE_PLUS,
    IN_CMD_MIN_HUE_MINUS,
    IN_CMD_MAX_HUE_SET,
    IN_CMD_MAX_HUE_PLUS,
    IN_CMD_MAX_HUE_MINUS,
    ...
    IN_CMD_RED_THRESHOLD_SET,
    IN_CMD_RED_THRESHOLD_PLUS,
    IN_CMD_RED_THRESHOLD_MINUS,
    IN_CMD_OTHER_THRESHOLD_SET,
    IN_CMD_OTHER_THRESHOLD_PLUS,
    IN_CMD_OTHER_THRESHOLD_MINUS,
    IN_CMD_CALIBRATE_PIXEL,
    IN_CMD_SET_ORANGE_CALIBRATION,
    IN_CMD_SET_YELLOW_CALIBRATION,
    IN_CMD_SET_GREEN_CALIBRATION,
    IN_CMD_SET_BLUE_CALIBRATION,
    IN_CMD_SET_BLACK_CALIBRATION,
    IN_CMD_SET_WHITE_CALIBRATION,
    IN_CMD_RESET_ORANGE_THRESHOLDS,
    IN_CMD_RESET_YELLOW_THRESHOLDS,
    IN_CMD_RESET_GREEN_THRESHOLDS,
    IN_CMD_RESET_BLUE_THRESHOLDS,
    IN_CMD_RESET_BLACK_THRESHOLDS,
    IN_CMD_RESET_WHITE_THRESHOLDS,
    IN_CMD_RESET_ALL_COLORS,
    IN_CMD_SAVE_ALL_COLORS,
...
static const struct {
  ...
  { "min_hue_set", IN_CMD_MIN_HUE_SET },
  { "min_hue_plus", IN_CMD_MIN_HUE_PLUS },
  { "min_hue_minus", IN_CMD_MIN_HUE_MINUS },
  { "max_hue_set", IN_CMD_MAX_HUE_SET },
  { "max_hue_plus", IN_CMD_MAX_HUE_PLUS },
  { "max_hue_minus", IN_CMD_MAX_HUE_MINUS },
  ...
  { "red_threshold_set", IN_CMD_RED_THRESHOLD_SET },
  { "red_threshold_plus", IN_CMD_RED_THRESHOLD_PLUS},
  { "red_threshold_minus", IN_CMD_RED_THRESHOLD_MINUS },
  { "other_threshold_set", IN_CMD_OTHER_THRESHOLD_SET },
  { "other_threshold_plus", IN_CMD_OTHER_THRESHOLD_PLUS},
  { "other_threshold_minus", IN_CMD_OTHER_THRESHOLD_MINUS },
  { "calibrate_pixel", IN_CMD_CALIBRATE_PIXEL },
  { "set_orange_calibration", IN_CMD_SET_ORANGE_CALIBRATION },
  { "set_green_calibration", IN_CMD_SET_GREEN_CALIBRATION },
  { "set_yellow_calibration", IN_CMD_SET_YELLOW_CALIBRATION },
  { "set_blue_calibration", IN_CMD_SET_BLUE_CALIBRATION },
  { "set_white_calibration", IN_CMD_SET_WHITE_CALIBRATION },
  { "set_black_calibration", IN_CMD_SET_BLACK_CALIBRATION },
  { "reset_orange_thresholds", IN_CMD_RESET_ORANGE_THRESHOLDS },
  { "reset_green_thresholds", IN_CMD_RESET_GREEN_THRESHOLDS },
  { "reset_yellow_thresholds", IN_CMD_RESET_YELLOW_THRESHOLDS },
  { "reset_blue_thresholds", IN_CMD_RESET_BLUE_THRESHOLDS },
  { "reset_black_thresholds", IN_CMD_RESET_BLACK_THRESHOLDS },
  { "reset_white_thresholds", IN_CMD_RESET_WHITE_THRESHOLDS },
  { "reset_all_colors", IN_CMD_RESET_ALL_COLORS },
  { "save_all_colors", IN_CMD_SAVE_ALL_COLORS },

  { "pan_left", IN_CMD_PAN_LEFT },
  { "pan_right", IN_CMD_PAN_RIGHT },
  { "tilt_up", IN_CMD_TILT_UP },
  { "tilt_down", IN_CMD_TILT_DOWN },
  { "reset_pan_tilt", IN_CMD_RESET_PAN_TILT },
  { "toggle_sit_stand", IN_CMD_TOGGLE_SIT_STAND },
